...
class AppSettings(BaseSettings):
    ...
    model_config = SettingsConfigDict(env_prefix="FOUNDRY_", extra="ignore", populate_by_name=True)
    ...
    gradium_api_key: SecretStr | None = Field(
        default=None,
        validation_alias=AliasChoices("FOUNDRY_GRADIUM_API_KEY", "GRADIUM_API_KEY"),
    )
